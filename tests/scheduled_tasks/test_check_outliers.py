...
class TestST_CheckOutliersByCampaignModel:
    def test_st_check_outliers_by_campaign_get_all_as_admin(
    ...
    def test_st_check_outliers_by_campaign_get_all_as_user(
        self, users, campaigns, st_check_outliers_by_campaigns
    ):
        user_1 = users[1]
    ...
    def test_st_check_outliers_by_campaign_delete_cascade(
        self, users, campaigns, st_check_outliers_by_campaigns
    ):
        admin_user = users[0]
        campaign_1 = campaigns[0]
